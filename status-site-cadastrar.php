...
if((!$_SESSION['permissao']['status_site']['cadastrar'] && !$_SESSION['permissao']['status_site']['editar']) || (!$_SESSION['permissao']['status_site']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Status Site"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Status Site"</h2>
<form id="form1" name="form1" method="post" action="status-site-listar.php" enctype="multipart/form-data">
<?php include('ajax.status-site.php'); ?>
</form>
