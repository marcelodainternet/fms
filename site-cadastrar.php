...
if((!$_SESSION['permissao']['site']['cadastrar'] && !$_SESSION['permissao']['site']['editar']) || (!$_SESSION['permissao']['site']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Site"</h2>
<form id="form1" name="form1" method="post" action="site-listar.php" enctype="multipart/form-data">
<?php include('ajax.site.php'); ?>
</form>
