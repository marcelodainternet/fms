...
if((!$_SESSION['permissao']['ccampos']['cadastrar'] && !$_SESSION['permissao']['ccampos']['editar']) || (!$_SESSION['permissao']['ccampos']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "cCampos"</h2>
<form id="form1" name="form1" method="post" action="ccampos-listar.php" enctype="multipart/form-data">
<?php
