...
if((!$_SESSION['permissao']['parceiros']['cadastrar'] && !$_SESSION['permissao']['parceiros']['editar']) || (!$_SESSION['permissao']['parceiros']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Parceiros"</h2>
<form id="form1" name="form1" method="post" action="parceiros-listar.php" enctype="multipart/form-data">
<?php include('ajax.parceiros.php'); ?>
</form>
