...
if((!$_SESSION['permissao']['tipos_tarefa']['cadastrar'] && !$_SESSION['permissao']['tipos_tarefa']['editar']) || (!$_SESSION['permissao']['tipos_tarefa']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Tipos Tarefa"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Tipos Tarefa"</h2>
<form id="form1" name="form1" method="post" action="tipos-tarefa-listar.php" enctype="multipart/form-data">
<?php include('ajax.tipos-tarefa.php'); ?>
</form>
