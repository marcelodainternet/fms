...
if((!$_SESSION['permissao']['e_mails_captados']['cadastrar'] && !$_SESSION['permissao']['e_mails_captados']['editar']) || (!$_SESSION['permissao']['e_mails_captados']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "E-mails Captados"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "E-mails Captados"</h2>
<form id="form1" name="form1" method="post" action="e-mails-captados-listar.php" enctype="multipart/form-data">
<?php include('ajax.e-mails-captados.php'); ?>
</form>
