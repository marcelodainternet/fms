...
if((!$_SESSION['permissao']['e_mails_automaticos']['cadastrar'] && !$_SESSION['permissao']['e_mails_automaticos']['editar']) || (!$_SESSION['permissao']['e_mails_automaticos']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "E-mails Automáticos"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "E-mails Automáticos"</h2>
<form id="form1" name="form1" method="post" action="e-mails-automaticos-listar.php" enctype="multipart/form-data">
<?php include('ajax.e-mails-automaticos.php'); ?>
</form>
