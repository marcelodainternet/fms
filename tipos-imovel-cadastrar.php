...
if((!$_SESSION['permissao']['tipos_imovel']['cadastrar'] && !$_SESSION['permissao']['tipos_imovel']['editar']) || (!$_SESSION['permissao']['tipos_imovel']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Tipos Imóvel"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Tipos Imóvel"</h2>
<form id="form1" name="form1" method="post" action="tipos-imovel-listar.php" enctype="multipart/form-data">
<?php include('ajax.tipos-imovel.php'); ?>
</form>
