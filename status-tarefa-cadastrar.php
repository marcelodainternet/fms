...
if((!$_SESSION['permissao']['status_tarefa']['cadastrar'] && !$_SESSION['permissao']['status_tarefa']['editar']) || (!$_SESSION['permissao']['status_tarefa']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Status Tarefa"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Status Tarefa"</h2>
<form id="form1" name="form1" method="post" action="status-tarefa-listar.php" enctype="multipart/form-data">
<?php include('ajax.status-tarefa.php'); ?>
</form>
