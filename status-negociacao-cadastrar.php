...
if((!$_SESSION['permissao']['status_negociacao']['cadastrar'] && !$_SESSION['permissao']['status_negociacao']['editar']) || (!$_SESSION['permissao']['status_negociacao']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Status Negociação"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Status Negociação"</h2>
<form id="form1" name="form1" method="post" action="status-negociacao-listar.php" enctype="multipart/form-data">
<?php include('ajax.status-negociacao.php'); ?>
</form>
