...
if((!$_SESSION['permissao']['tipos_produto']['cadastrar'] && !$_SESSION['permissao']['tipos_produto']['editar']) || (!$_SESSION['permissao']['tipos_produto']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Tipos Produto"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Tipos Produto"</h2>
<form id="form1" name="form1" method="post" action="tipos-produto-listar.php" enctype="multipart/form-data">
<?php include('ajax.tipos-produto.php'); ?>
</form>
