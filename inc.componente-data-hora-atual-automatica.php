...
?>
<input type="hidden" name="<?php echo $ppropriedade ?>" id="<?php echo $ppropriedade ?>" value="<?php if(!$_GET['editar']){ ${$ttabela}[$ppropriedade] = date('Y-m-d H:i'); } echo str_replace(' ', 'T', ${$ttabela}[$ppropriedade]); ?>" />
<?php
}
unset($ppropriedade);
?>