...
if((!$_SESSION['permissao']['secoes']['cadastrar'] && !$_SESSION['permissao']['secoes']['editar']) || (!$_SESSION['permissao']['secoes']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Seções"</h2>
<form id="form1" name="form1" method="post" action="secoes-listar.php" enctype="multipart/form-data">
<?php include('ajax.secoes.php'); ?>
</form>
