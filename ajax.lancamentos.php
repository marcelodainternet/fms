...
?>
<?php
$llabel = 'Tipo'; $cclasse = 'tipos_lancamento'; $ppropriedade = 'nome';
$pparametros[] = 'onchange="carrega_campos(\''.$aarquivo.'\');"';
include('inc.componente-selecao.php');
?>
<?php
...
?>
<?php
$llabel = 'Status'; $cclasse = 'status_lancamento'; $ppropriedade = 'nome';
$pparametros[] = 'onchange="carrega_campos(\''.$aarquivo.'\');"';
include('inc.componente-selecao.php');
?>
<?php
...
?>
<?php
$llabel = 'Pedido'; $cclasse = 'pedidos'; $ppropriedade = 'pedido';
$pparametros[] = 'onchange="carrega_campos(\''.$aarquivo.'\');"';
include('inc.componente-selecao.php');
?>
<?php
...
?>
<?php
$llabel = 'Parceiro'; $cclasse = 'parceiros'; $ppropriedade = 'nome';
$pparametros[] = 'onchange="carrega_campos(\''.$aarquivo.'\');"';
include('inc.componente-selecao.php');
?>
<?php
...
?>
<?php
$llabel = 'Valor Recorrente';
include('inc.componente-moeda.php');
?>
<?php
$llabel = 'Próximo Pagamento';
include('inc.componente-data.php');
?>
<?php
$llabel = 'Ultimo Pagamento';
include('inc.componente-data.php');
?>
<?php
$llabel = 'Observações';
