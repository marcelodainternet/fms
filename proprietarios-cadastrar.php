...
if((!$_SESSION['permissao']['proprietarios']['cadastrar'] && !$_SESSION['permissao']['proprietarios']['editar']) || (!$_SESSION['permissao']['proprietarios']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Proprietários"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Proprietários"</h2>
<form id="form1" name="form1" method="post" action="proprietarios-listar.php" enctype="multipart/form-data">
<?php include('ajax.proprietarios.php'); ?>
</form>
