...
if((!$_SESSION['permissao']['usuarios']['cadastrar'] && !$_SESSION['permissao']['usuarios']['editar']) || (!$_SESSION['permissao']['usuarios']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Usuários"</h2>
<form id="form1" name="form1" method="post" action="usuarios-listar.php" enctype="multipart/form-data">
<?php include('ajax.usuarios.php'); ?>
</form>
