...
if((!$_SESSION['permissao']['etiquetas_imovel']['cadastrar'] && !$_SESSION['permissao']['etiquetas_imovel']['editar']) || (!$_SESSION['permissao']['etiquetas_imovel']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Etiquetas Imóvel"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Etiquetas Imóvel"</h2>
<form id="form1" name="form1" method="post" action="etiquetas-imovel-listar.php" enctype="multipart/form-data">
<?php include('ajax.etiquetas-imovel.php'); ?>
</form>
