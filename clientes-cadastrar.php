...
if((!$_SESSION['permissao']['clientes']['cadastrar'] && !$_SESSION['permissao']['clientes']['editar']) || (!$_SESSION['permissao']['clientes']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Clientes"</h2>
<form id="form1" name="form1" method="post" action="clientes-listar.php" enctype="multipart/form-data">
<?php include('ajax.clientes.php'); ?>
</form>
