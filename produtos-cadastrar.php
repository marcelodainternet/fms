...
if((!$_SESSION['permissao']['produtos']['cadastrar'] && !$_SESSION['permissao']['produtos']['editar']) || (!$_SESSION['permissao']['produtos']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Produtos"</h2>
<form id="form1" name="form1" method="post" action="produtos-listar.php" enctype="multipart/form-data">
<?php include('ajax.produtos.php'); ?>
</form>
