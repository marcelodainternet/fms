...
?>
<input type="hidden" name="<?php echo $ppropriedade ?>" id="<?php echo $ppropriedade ?>" value="<?php if(!$_GET['editar']){ ${$ttabela}[$ppropriedade] = date('H:i'); } echo ${$ttabela}[$ppropriedade]; ?>" />
<?php
}
unset($ppropriedade);
?>