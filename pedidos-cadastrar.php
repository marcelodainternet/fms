...
if((!$_SESSION['permissao']['pedidos']['cadastrar'] && !$_SESSION['permissao']['pedidos']['editar']) || (!$_SESSION['permissao']['pedidos']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Pedidos"</h2>
<form id="form1" name="form1" method="post" action="pedidos-listar.php" enctype="multipart/form-data">
<?php include('ajax.pedidos.php'); ?>
</form>
