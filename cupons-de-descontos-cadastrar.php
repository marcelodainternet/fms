...
if((!$_SESSION['permissao']['cupons_de_descontos']['cadastrar'] && !$_SESSION['permissao']['cupons_de_descontos']['editar']) || (!$_SESSION['permissao']['cupons_de_descontos']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Cupons de Descontos"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Cupons de Descontos"</h2>
<form id="form1" name="form1" method="post" action="cupons-de-descontos-listar.php" enctype="multipart/form-data">
<?php include('ajax.cupons-de-descontos.php'); ?>
</form>
