...
doneButton: false,
doneButtonText: '<i class="fas fa-search"></i> Pesquisar',
multipleSeparator: ', ',
styleBase: 'btn',
...
// Elements
var header = this.options.header ? '<div class="bs-donebutton">' +
'<div class="btn-group btn-block">' +
'<button type="submit" class="btn btn-sm ' + classNames.BUTTONCLASS + '">' +
...
'<input autocomplete="<?php echo rand(); ?>" type="text" class="form-control" autocomplete="off"' +
