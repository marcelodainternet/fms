...
if((!$_SESSION['permissao']['tarefas']['cadastrar'] && !$_SESSION['permissao']['tarefas']['editar']) || (!$_SESSION['permissao']['tarefas']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Tarefas"</h2>
<form id="form1" name="form1" method="post" action="tarefas-listar.php" enctype="multipart/form-data">
<?php include('ajax.tarefas.php'); ?>
</form>
