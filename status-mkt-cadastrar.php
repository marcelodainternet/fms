...
if((!$_SESSION['permissao']['status_mkt']['cadastrar'] && !$_SESSION['permissao']['status_mkt']['editar']) || (!$_SESSION['permissao']['status_mkt']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Status Mkt"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Status Mkt"</h2>
<form id="form1" name="form1" method="post" action="status-mkt-listar.php" enctype="multipart/form-data">
<?php include('ajax.status-mkt.php'); ?>
</form>
