...
if((!$_SESSION['permissao']['lancamentos']['cadastrar'] && !$_SESSION['permissao']['lancamentos']['editar']) || (!$_SESSION['permissao']['lancamentos']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Lançamentos"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Lançamentos"</h2>
<form id="form1" name="form1" method="post" action="lancamentos-listar.php" enctype="multipart/form-data">
<?php include('ajax.lancamentos.php'); ?>
</form>
