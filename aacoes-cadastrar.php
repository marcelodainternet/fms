...
if((!$_SESSION['permissao']['aacoes']['cadastrar'] && !$_SESSION['permissao']['aacoes']['editar']) || (!$_SESSION['permissao']['aacoes']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "aAções"</h2>
<form id="form1" name="form1" method="post" action="aacoes-listar.php" enctype="multipart/form-data">
<?php
$llabel = 'Nome';
