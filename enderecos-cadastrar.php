...
if((!$_SESSION['permissao']['enderecos']['cadastrar'] && !$_SESSION['permissao']['enderecos']['editar']) || (!$_SESSION['permissao']['enderecos']['cadastrar'] && !$_GET['editar'])){
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Endereços"</h2>
<form id="form1" name="form1" method="post" action="enderecos-listar.php" enctype="multipart/form-data">
<?php include('ajax.enderecos.php'); ?>
</form>
