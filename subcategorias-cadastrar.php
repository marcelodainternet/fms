...
if((!$_SESSION['permissao']['subcategorias']['cadastrar'] && !$_SESSION['permissao']['subcategorias']['editar']) || (!$_SESSION['permissao']['subcategorias']['cadastrar'] && !$_GET['editar'])){
...
<head>
<?php
$ttitulo = 'Cadastro de "Subcategorias"';
...
?>
<div class="row">
<h2 style="margin:15px;">Cadastro de "Subcategorias"</h2>
<form id="form1" name="form1" method="post" action="subcategorias-listar.php" enctype="multipart/form-data">
<?php include('ajax.subcategorias.php'); ?>
</form>
